...
public class CreateManagedCaseValidator : AbstractValidator<CreateManagedCase.Command>
{
    public CreateManagedCaseValidator()
    {
        RuleFor(x => x.Case.ClientId).GreaterThan(0);
        RuleFor(x => x.Case.LawyerId).GreaterThan(0);
